...
label_planet = Label(root, text="Planet : ", bg="royalblue")
label_planet_name = Label(root, font=("Arial Rounded MT Bold", 18,"bold"),bg="royalblue")
label_planet_image = Label(root, bg="gold2", highlightthickness=5, borderwidth=2, relief=RIDGE)
label_planet_gravity_radius = Label(root,font="castellar", bg="royalblue")
label_planet_info = Label(root, font=("Arial Rounded MT Bold",10,"bold"), bg="lightblue", wraplength=500)
...
label_planet.place(relx=0.2, rely=0.18, anchor=CENTER)
